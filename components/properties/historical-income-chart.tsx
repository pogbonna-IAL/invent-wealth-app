...
interface HistoricalIncomeChartProps {
  statements: Array<{
    periodStart: Date | string;
    grossRevenue: number | string;
    netDistributable: number | string;
    occupancyRatePct: number | string;
    adr: number | string;
  }>;
}

export function HistoricalIncomeChart({ statements }: HistoricalIncomeChartProps) {
